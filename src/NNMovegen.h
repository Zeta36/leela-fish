...
#ifndef NNMOVEGEN_H_INCLUDED
#define NNMOVEGEN_H_INCLUDED
...
ExtMove* generate_castling(const NNPosition& pos, ExtMove* moveList, Color us) {
...
ExtMove* generate_king_moves(const NNPosition& pos, ExtMove* moveList, Bitboard target) {
...
ExtMove* generate_castling_moves(const NNPosition& pos, ExtMove* moveList) {
...
ExtMove* generate_pawn_moves(const NNPosition& pos, ExtMove* moveList, Bitboard target) {
...
ExtMove* generate_moves(const NNPosition& pos, ExtMove* moveList, Color us,
                        Bitboard target) {
...
template<GenType>
ExtMove* generate(const NNPosition& pos, ExtMove* moveList);
...
struct MoveList {
  ...
  explicit MoveList(const NNPosition& pos) : last(generate<T>(pos, moveList)) {}
